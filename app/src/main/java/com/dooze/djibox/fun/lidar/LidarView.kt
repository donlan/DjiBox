package com.dooze.djibox.`fun`.lidar
...
import com.dooze.djibox.databinding.ViewLidarBinding
import com.dooze.djibox.internal.utils.ToastUtils
import com.dooze.djibox.internal.utils.ViewHelper
import com.dooze.djibox.internal.view.PopupNumberPicker
import com.dooze.djibox.internal.view.PopupNumberPickerDouble
...
class LidarView(context: Context) : LinearLayout(context), PresentableView, View.OnClickListener {
    ...
    private var binding:ViewLidarBinding? = null
    ...
    private fun initUI(context: Context) {
        ...
        val binding = ViewLidarBinding.bind(this)
